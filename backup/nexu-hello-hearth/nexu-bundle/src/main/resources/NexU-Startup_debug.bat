...
start "" "__{app}"\java\bin\javaw.exe -Djavafx.preloader=lu.nowina.nexu.NexUPreLoader -Dglass.accessible.force=false -Xdebug -Xrunjdwp:transport=dt_socket,address=8989,server=y,suspend=n -jar "__{app}"\nexu.jar